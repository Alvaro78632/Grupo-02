...
public class ClienteServicios {
	...
	public static void eliminarCliente() {
		int idCliente = LecturaDatos.leerInt("Introduzca el Id de cliente que desea eliminar: ");	//PEDIMOS EL DATO --> almacenamos en variable
		try {
	...
	//Nino: he realizado este método modificar...comprobar mañana chicos.
		public static void modificarCliente() {
			...
			int idCliente = LecturaDatos.leerInt("Introduzca el Id de cliente que desea modificar: ");	//PEDIMOS EL DATO --> almacenamos en variable
			if(ClienteDatos.comprobarCliente(idCliente)) 
			{																							//SI el cliente esta eN la BBDD
				
				/*String nombre=LecturaDatos.leerLine("Introduzca el nombre del cliente que desea modificar");
				String fechaRegistroComoTexto = LecturaDatos.leerLine("Introduzca la fecha que desea modificar");
				SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
				Date fechaRegistro = sdf.parse(fechaRegistroComoTexto);*/
