...
public class Conectar {
	...
	public static Connection Conexion() {
		...
		String contrasenya = "user";
		String usuario = "user";
		String bbdd = "MovieFlix";
		String url = "jdbc:mysql://10.90.36.106:3306/";
		String prop = "useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
		
/*		
		String contrasenya = "S$+&Cl[pEbU~Rw$3";
		String usuario = "id13773954_prueba";
		String bbdd = "id13773954_movieflix";
		String url = "jdbc:mysql://movieflix2.000webhostapp.com/";
		String prop = "useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
*/
